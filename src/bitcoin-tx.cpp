...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Unbreakablecoin Core unbreakablecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  unbreakablecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded unbreakablecoin transaction") + "\n" +
              "  unbreakablecoin-tx [options] -create [commands]   " + _("Create hex-encoded unbreakablecoin transaction") + "\n" +
              "\n";
