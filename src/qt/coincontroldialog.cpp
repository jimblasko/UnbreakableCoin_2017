    ...
    model(0)
{
    ...
    // see https://github.com/unbreakablecoin/unbreakablecoin/issues/5716
    ...
    BOOST_FOREACH(PAIRTYPE(QString, vector<COutput>) coins, mapCoins)
    {
        ...
        BOOST_FOREACH(const COutput& out, coins.second)
        {
            ...
            if(ExtractDestination(out.tx->vout[out.i].scriptPubKey, outputAddress))
            {
                ...
                // if listMode or change => show unbreakablecoin address. In tree mode, address is not shown again for direct wallet address outputs
