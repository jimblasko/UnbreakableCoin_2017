    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Unbreakablecoin Core");
    QString versionText     = QString("Version %1").arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightText   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Unbreakablecoin Core developers"));
