...
public:
    CMainParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(0);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(5);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(128);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0xfa)(0xbf)(0xb5)(0xda).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0xfa)(0xbf)(0xb5)(0xda).convert_to_container<std::vector<unsigned char> >();
